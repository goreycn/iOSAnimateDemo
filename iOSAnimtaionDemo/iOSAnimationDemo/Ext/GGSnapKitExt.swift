...
public extension ConstraintDescriptionExtendable {
    ...
    func e(other: ConstraintItem, _ offset:CGFloat = 0) -> ConstraintDescriptionEditable {
        return equalTo(other).offset(offset)
    }
    
    func e( other: View, _ offset:CGFloat = 0) -> ConstraintDescriptionEditable {
        return equalTo(other).offset(offset)
    }
    
    func le( other: ConstraintItem, _ offset:CGFloat = 0) -> ConstraintDescriptionEditable {
        return lessThanOrEqualTo(other).offset(offset)
    }
    
    func le(other: View, _ offset:CGFloat = 0) -> ConstraintDescriptionEditable {
        return lessThanOrEqualTo(other).offset(offset)
    }
    
    func ge(other: ConstraintItem, _ offset:CGFloat = 0) -> ConstraintDescriptionEditable {
        return greaterThanOrEqualTo(other).offset(offset)
    }
    
    func ge(other: View, _ offset:CGFloat = 0) -> ConstraintDescriptionEditable {
        return greaterThanOrEqualTo(other).offset(offset)
    }
    
    func e(other: Int) -> ConstraintDescriptionEditable {
        return equalTo(other)
    }
    
    func e(other: Float) -> ConstraintDescriptionEditable {
        return equalTo(other)
    }
}
